...
document.addEventListener('DOMContentLoaded', function () {
    const button = document.getElementById('user-menu-button-tablet');
    const menu = document.getElementById('user-menu-tablet');
...
const formCode = document.getElementById('open-form-code');
if (formCode) {
    formCode.addEventListener('click', function () {
