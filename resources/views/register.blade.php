        ...
        <div class="flex justify-center px-6 {{ $errors->any() ? 'py-6' : 'py-24' }}">
            ...
            <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                ...
                <div class="w-full h-auto   hidden lg:block lg:w-5/12 bg-cover rounded-l-lg"
                    style="background-image: url('{{ asset('images/Logo_BEG.png') }}');">
                </div>

                <!-- Col -->
                <div class="w-full lg:w-7/12 bg-black/50  p-5 rounded-lg lg:rounded-l-none  text-white">
                    <h3 class="py-4 text-2xl text-center text-white dark:text-white uppercase font-bold">Crea una cuenta
                    </h3>
                        ...
                        <div class="mb-4 md:flex md:justify-center">
                            ...
                            <div class="mb-4 md:mb-0 md:w-1/2 ">
                                ...
                                <input
                                    ...
                                    id="email" name="email" type="text" placeholder="tu@example.com" value="{{ old('email') }}" />
                            </div>
                            <div class="mb-4 md:mb-0 md:w-1/2 md:ml-2">
                                ...
                                <input
                                    class="w-full px-3 py-2 text-sm   text-black border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="celular" name="celular" type="text" placeholder="Celular"  value="{{ old('celular') }}"/>
                            </div>
                        </div>
