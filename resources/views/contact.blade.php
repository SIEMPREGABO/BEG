                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="subject" name="subject"
                                class="w-full px-3 py-2 border border-opacity-5 rounded-md bg-white bg-opacity-25" value="" required>

                        </div>
                        <div class="mb-4">
                            <label for="message" class="block text-gray-400">Mensaje</label>
                            <textarea id="message" name="message" rows="4" class="w-full px-3 py-2 border border-opacity-5 rounded-md bg-white bg-opacity-25"
                                required></textarea>
