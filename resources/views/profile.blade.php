                            ...
                            <div class=" px-3 my-3 w-full" id='{{ $address->id }}'>
                                <div class=" w-full lg:max-w-full md:flex md:justify-center ">
                                    <div
                                        ...
                                        <div class="">
                                            <div class="text-base text-gray-400 flex items-center mb-1">
                                                <i class="fa-solid fa-location-dot"></i>&nbsp;
                                                {{ $address->estado }}, {{ $address->municipio }}&nbsp; <i
                                                    class=" leading-none my-1">{{ $address->cp }}</i>
                                            </div>
                                        ...
                                        <div class="flex" style="justify-content: space-around">
                                            ...
                                            {{-- <div class="flex justify-end w-1/2"> --}}
                                                <button class="fa-solid fa-lg fa-pen-to-square p-1" style="color: #00ff9d;"
                                                ...
                                                <form action="{{ route('EliminarDireccion') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name='id_address' id='id_address'
                                                        value="{{ $address->id }}">
                                                    <button type="submit" class=" p-2" style="color: #00ff9d;">
                ...
                <div class="relative p-4 w-full max-w-md">
                    ...
                    <div class="relative rounded-lg shadow bg-black">
                        ...
                        <div
                            ...
                            <button type="button"
                                class="botones-neon-green-s-border"
                        ...
                        <div class="p-4 md:p-5">
                            <form action="{{ route('ActualizarDireccion') }}"
                                class="px-8 pt-3  mb-4   rounded" method="POST" id="edit_address_form"
